...
const VehiclePanel = (props) => {
  return (
    <div>
      ...
      <div onClick={() =>{
      ...
      }} className="mb-2 flex items-center justify-between border-2 active:border-black rounded-xl w-full p-3 cursor-pointer">
        <img
          className="h-12"
        ...
        <div className="w-1/2 p-2 rounded-lg">
          <h4 className="font-medium text-base">
            Uber Go <span><i className="ri-user-3-fill"></i> 4</span>
          </h4>
      ...
      <div onClick={() =>{
        ...
        <div className="w-1/2 p-2 rounded-lg">
          <h4 className="font-medium text-base">
            Uber Auto <span><i className="ri-user-3-fill"></i> 3</span>
          </h4>
          <h5 className="font-medium text-base">3 mins away</h5>
